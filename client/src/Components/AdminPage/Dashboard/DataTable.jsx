...
// import "https://raw.githubusercontent.com/VigneshSubramanian15/vs-react-datatable/master/src/style.css";
export default function DataTable(props) {
    ...
    const MasterSearch = (masterSearch, fieldSearch, Range) => {
        ...
        console.log({ mastersearch, fieldsearch, range, completeData });
        let filtered = [];
        let data = completeData;
        console.log(parseInt(masterSearch));
        //MasterSearch
        data.map((row) => {
            row.some((col) => {
                if (isNaN(col)) {
                    try {
                        if (
                            mastersearch
                                .toLowerCase()
                                .search(mastersearch.toLowerCase()) !== -1
                        ) {
                            filtered.push(row);
                            return true;
                        }
                        ...
                        try {
                            if (
                                mastersearch.search(parseInt(mastersearch)) !==
                                -1
                            ) {
                                filtered.push(row);
                                return true;
